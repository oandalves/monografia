...
@section('content_header')
    <h4><b>Cadastrar novo feirante</b></h4>
@stop
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Tipo</label>
                                            <select class="custom-select rounded-0" name="tipo">
                                                <option>Selecione</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select rounded-0" name="certificacao">
                                                ...
                                                <option value="Orgânica">Orgânica</option>
                                                <option value="Agroecológica">Agroecológica</option>
                                                <option value="Comércio justo (Fair trade)">Comércio justo (Fair trade)
                                                </option>
